...
remote_directory "D:\\Inetpub\\wwwroot" do
  source "wwwroot"
  action :create
end
...
iis_app "VeretechServices" do
  site_name 'Default Web Site'
  path "/VeretechServices"
  application_pool "VeretechServices"
  physical_path "#{node['iis']['docroot']}/VeretechServices"
  enabled_protocols "http,net.pipe"
  action :add
end
